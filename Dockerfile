...
# ROS 2 Humble + Gazebo Classic 11 + apartment_sim, reproducible build.
# Build context = repo root.  See README section "Quick start with Docker".
FROM osrf/ros:humble-desktop

ARG DEBIAN_FRONTEND=noninteractive
SHELL ["/bin/bash", "-c"]

# --- Packages (mirrors install.sh step 4; desktop image already has rviz2/rsp/xacro) ---
